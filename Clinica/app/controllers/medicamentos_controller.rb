class MedicamentosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @medicamento.save
        format.html { redirect_to @medicamento, notice: 'Medicamento foi criado com sucesso.' }
  ...
  def update
    respond_to do |format|
      if @medicamento.update(medicamento_params)
        format.html { redirect_to @medicamento, notice: 'Medicamento foi editado com sucesso.' }
  ...
  def destroy
    @medicamento.destroy
    respond_to do |format|
      format.html { redirect_to medicamentos_url, notice: 'Medicamento foi deletado com sucesso.' }
  ...
  private
    ...
    def medicamento_params
      params.require(:medicamento).permit(:nome_medicamento, :uso)
    end
end
